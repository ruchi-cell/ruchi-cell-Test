      ...
      <ul class="nav bd-sidenav"><li>
          ...
          <nav class="d-none d-xl-block col-xl-2 bd-toc" aria-label="Secondary navigation">
            <ul class="section-nav">
                 ...
                 <li class="toc-entry toc-h2"><a href="#id2">Enqueue Operation</a></li>
                 <li class="toc-entry toc-h2"><a href="#id2">Dequeue Operation</a></li>          
                 <li class="toc-entry toc-h2"><a href="#id2">Peek Operation</a></li>
                 <li class="toc-entry toc-h2"><a href="#id2"> Application of Queue</a></li>
        ...
        <main class="col-md-9 col-xl-8 py-md-3 pl-md-5 bd-content" role="main">
          <div class="d-md-flex flex-md-row-reverse align-items-center justify-content-between">
            ...
            <h1 class="bd-title" id="content">QUEUE</h1>
          </div>
          <p class="bd-lead"></p>
          
            <h2 id="changeidaccordingly">What is Queue?</h2>
            <p>
            <strong>Queue</strong> is an abstract data type. Now saying abstract means that we only<br>
                worry about the operations provided by the queue, don’t worry about <br>
                implementation. Of course we have to implement it. It is implemented with<br> 
                the help of an array or linked list.<br>
                It works on the concept of <strong>“First In First Out”.</strong><br><br>

                Let’s understand the concept of queue by an example. Suppose you have <br>
                to deposit the cash into your account. You go to the bank and stand in a<br>
                 queue at the deposit counter. It’s one of the real life examples. That’s how<br>
                  the queue works. The customer who came first will be given a chance to<br>
                   deposit the case. You have to wait until your frontiers are not deposited.<br><br>

                 The basic operation of queue are: enqueue(), dequeue() and peek()<br><br>
    </p>

    <h2 id="id2"><strong>Enqueue Operation:</strong></h2> 
                We have to simply add the new element at the end of the queue.<br>
                It’s very simple and can be done in O(1).<br>
            </p>
...
table td {
    ...
    padding:4px 8px;
            ...
            <h2 id="id2"><strong>Dequeue Operation:</strong></h2> 
            We just have to simply remove the element from the front(the opposite site<br>
             from where element is added). Or In simple words from the starting at the <br>
             beginning of the queue. It can be done in O(1).<br>
            </p> 
            <table>
                <tr>
                queue.dequeue();
            ...
            <h2 id="id2"><strong>Peek Operation:</strong></h2> 
             Peek operation just tells the value of the front element. It does not remove<br>
             any element from the queue. It’s simple and can be done in O(1).<br>
            </p> 
            <table>
            ...
            Queue<br><br>
            <h2 id="id2"><strong>Application:</strong></h2>
            <p>
            <ul>
            <li>In the BFS algorithm, It is used as the underlying data structure.</li>
           <li> In CPU scheduling, when a resource is shared among several<br> threads. We store them in a queue.</li><br>
            </p>
