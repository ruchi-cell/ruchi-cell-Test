...
<div class="container-fluid">
  ...
  <button class="btn bd-search-docs-toggle d-md-none p-0 ml-3" type="button" data-toggle="collapse" data-target="#bd-docs-nav" aria-controls="bd-docs-nav" aria-expanded="false" aria-label="Toggle docs navigation"><svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 30 30" role="img" focusable="false"><title>Menu</title><path stroke="currentColor" stroke-linecap="round" stroke-miterlimit="10" stroke-width="2" d="M4 7h22M4 15h22M4 23h22"></path></svg></button>
         ...
         <h1 class="bd-title" id="content">Helpful Functions</h1>
          </div>
          <p class="bd-lead"></p>
            <p>
            MATLAB provides many hundreds of built-in functions. Here, we provide tables of some of them<br>
             that might be helpful to you in working problems for this course and later for applying what you <br>
             learn in this course1: </p><br><br>
             <h2 class="bd-title" id="content"> Table 1. Matrix-building functions</h2><br>
              <!--Image -->
              <img src="imagess/Screenshot (151).png">
                    </a><br><br><br>
             <h2 class="bd-title" id="content">Table 2. Trigonometric functions</h2><br>
                     <!--Image -->
             <img src="imagess/Screenshot (152).png">
                    </a><br><br><br> 
             <h2 class="bd-title" id="content"> Table 3. Exponential functions </h2><br>
                    <!--Image -->
             <img src="imagess/Screenshot (153).png">
                    </a><br><br><br>
              <h2 class="bd-title" id="content">Table 4. Functions that work on complex numbers </h2><br>
                     <!--Image -->
             <img src="imagess/Screenshot (154).png">
                    </a><br><br><br>
             <h2 class="bd-title" id="content">Table 5. Rounding and remainder functions </h2><br>
                     <!--Image -->
             <img src="imagess/Screenshot (155).png">
                    </a><br><br><br>
              <h2 class="bd-title" id="content"> Table 6. Descriptive functions applied to a vector </h2><br>
                     <!--Image -->
             <img src="imagess/Screenshot (156).png">
                    </a><br><br><br>
              <h2 class="bd-title" id="content"> Table 7. Descriptive functions applied to a two-dimensional matrix </h2><br>
                     <!--Image -->
             <img src="imagess/Screenshot (157).png">
                    </a><br><br><br>
    </main>
    </div>
    </div>   
